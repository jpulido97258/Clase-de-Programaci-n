...
'Ahora vas a pedir que te lancen los balones altos a un lugar diferente, los balones deben ser difíciles de pasar, vas a levantar 5 balones a 4, 5 balones a 3 y 5 balones a 2, cada uno en sus zonas determinadas anteriormente.' )
...
EfectividadVoleo=float((pro4+pro5+pro6+pro7))
